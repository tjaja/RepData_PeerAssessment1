...
```{r histogram1, fig.width=10, echo=TRUE}
p1 
```
<br>  
...
```{r linegraph1, fig.width=8, echo=TRUE}
p2
```
<br>  
...
```{r histogram2, fig.width=10, echo=TRUE}
p3
```
<br>  
The mean total number of steps taken per day:  
...
```{r linegraph2, fig.width=8, echo=TRUE}
p4
```
<br>  
